...
<html>
    <head>
        ...
        <link href="<?php echo get_template_directory_uri(); ?>/admin/testimonial/css/admin_style.css" rel="stylesheet" type="text/css">     
    </head>
    <body>
        <div class="wrap">
            ...
            <div class="form-group">
              <form  role="form" name="health_reg" id="health_reg" action="" method="post">
                       <p class="search-box">
                        ...
                        <div id="suggesstion-box" class="suggestionbox"></div> 
                       </p>
              </form>
            </div>                                                                                                                   
        </div> 
            ...
            $(document).ready(function(){
                $('#btn-submit').click(function(e){   
                    ...
                    if(fname !=''){
                        ...
                        var dataString = 'search_name='+fname;  
                        $.ajax({
